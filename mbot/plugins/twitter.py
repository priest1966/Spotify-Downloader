...
async def twitter_handler(Mbot, message):
   try:            
      ...
      try:
          dump_file = await message.reply_video(link,caption="Thank you for using - @Spotiverse_bot")
             ...
             await snd_message.delete()
              ...
              try:
                  ...
                  try:
                     ...
                     await asyncio.sleep(1)
                     await message.reply_video(content_value,caption="Thank you for using - @Spotiverse_bot")
